 ...
 * 
 * In general, every source file (HelloPrinter.java) contains one class
 *      (HelloPrinter).
 *      
...
public class HelloPrinter
{
    ...
    public static void main( String[] args )
    {
        ...
        /*
         * Identifiers are case sensitive (case matters). These are three
        ...
        /*
         * This is a run-time error. (This code copmiles and runs, but
         *      it doesn't produce the expected output.)
         * 
